...
<head>
  ...
  <!-- 2nd Template CSS -->
  <link rel="stylesheet" href="<?php echo base_url('assets/assets_stisla') ?>/assets/css/register_css/register-style.css">
  <link
      rel="stylesheet"
      href="<?php echo base_url('assets/assets_stisla') ?>/assets/css/register_css/material-design-iconic-font.min.css"
    />
