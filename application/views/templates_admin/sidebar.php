      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="<?php echo (strpos(current_url(), "admin/data_type") !== false) ? "active" : ""?>"><a class="nav-link" href="<?php echo base_url('admin/data_type') ?>"><i class="fas fa-grip-horizontal"></i> <span>Data Tipe Mobil</span></a></li>
